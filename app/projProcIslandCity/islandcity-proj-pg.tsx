    ...
    return (
        <pages.GroupProjectPage overflowStyle="overflow-y-scroll">
            ...
            <gallery.ProjectDetailRelativeText 
                TitleText="ISLAND CITY GENERATOR"
                ExtraProjInfo="PERSONAL | PROCEDURAL DESIGNER" 
                MoreText="This procedural generating system took many of my learned node and shader skills to develop. 
