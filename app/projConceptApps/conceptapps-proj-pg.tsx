...
function BentoBoxA() {
    return (
        <div className={`relative z-auto grid grid-cols-1 w-[80%] h-fit justify-self-center rounded-3xl place-content-center gap-[12px] text-white`}>
                ...
                <div className={`${CheckIfMobileBrowser() ? "grid-cols-2" : "grid-cols-3 grid-rows-2"} grid gap-[12px] hover:z-20`}>
...
function BentoBoxB() {
    return (
        <div className={`relative z-auto grid grid-cols-1 w-[80%] h-fit justify-self-center rounded-3xl place-content-center gap-[12px] text-white`}>
                ...
                <div className={`${CheckIfMobileBrowser() ? "grid-cols-2" : "grid-cols-3 grid-rows-2"} grid gap-[12px] hover:z-20`}>
                    <bentos.CellMediaOnClick mediaText="Podcast collected screens designs" mediaLink={imgConceptAppB01} mediaType={MediaType.Image} cellSpan="col-span-2 row-span-2" hoverTextColor="text-textColor"/>
                    ...
                    <bentos.CellMediaOnClick mediaText='Podcast design page "Play Now"' mediaLink={imgConceptAppB02} mediaType={MediaType.Image} cellSpan="col-span-1" hoverTextColor="text-textColor"/>
                </div>
                
                <div className={`${CheckIfMobileBrowser() ? "" : ""} grid grid-cols-3 gap-[12px] hover:z-20`}>
