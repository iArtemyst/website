...
export default function HorrorHousesPage() {
    return (
        <pages.GroupProjectPage overflowStyle="overflow-y-scroll">
                ...
                TitleText="HORROR HOUSES" 
                ExtraProjInfo="PERSONAL | 3D ARTIST"
                MoreText="A good friend of mine, @KaitlinMooresArt, posted drawings she did of a few famous structures from horror films. 
