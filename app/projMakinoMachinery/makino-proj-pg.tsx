    ...
    return (
        <div className={`${bentoGap} grid-cols-2 relative z-auto grid w-[80%] h-auto justify-self-center rounded-3xl place-content-center text-white hover:cursor-pointer`} >
            ...
            <bentos.CellText cellSpan="sm:col-span-1 col-span-2">
                <bentos.ParagraphText text="In addition to creating videos for the trade show applications, the company I was working with also developed and supported a standalone sales application that included Augmented Reality Digital Twins of the Machines, and allowed users of the app to click into the feature device at specific areas to pull up the related feature videos I was creating. I also helped my team in remodeling the high-poly CAD models provided by the client into low-poly AR ready models, and worked on a pipeline for automatically converting and generating the engine ready models." />
            </bentos.CellText>
