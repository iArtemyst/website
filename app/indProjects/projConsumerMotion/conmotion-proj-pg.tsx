    ...
    return (
        <div className={`${bentoGap} relative z-auto grid grid-cols-1 w-[80%] h-auto justify-self-center rounded-3xl place-content-center gap-[12px] text-textVariant hover:cursor-pointer`}>
            ...
            <div className={`${bentoGap} grid grid-cols-2 gap-[12px]`}>
                <div className={`${bentoGap} grid grid-cols-2 gap-[12px]`}>
                <bentos.CellMediaOnClick mediaText="Derisking through trial" mediaLink={imgConMotionC01} cellSpan="col-span-1"/>
                <bentos.CellMediaOnClick mediaText="Dental Map" mediaLink={imgConMotionA04} cellSpan="col-span-1"/>
                <bentos.CellMediaOnClick mediaText="Shared Intelligence" mediaLink={imgConMotionD03} cellSpan="col-span-1"/>
                <bentos.CellMediaOnClick mediaText="Reduced lead times" mediaLink={imgConMotionC06} cellSpan="col-span-1"/>
                </div>

                <bentos.CellMediaOnClick mediaLink={vidConMotionA01} mediaText="Test Text" cellSpan="col-span-1" />

                <bentos.CellMediaOnClick mediaLink={vidConMotionB02} mediaText="Test Text" cellSpan="col-span-1" /> 
                ...
                <div className={`${bentoGap} grid grid-cols-2 col-span-1 gap-[12px]`}>
                    <bentos.CellMediaOnClick mediaText="Internal Research" mediaLink={imgConMotionB01} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Connected Software" mediaLink={imgConMotionA03} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Discovery" mediaLink={imgConMotionB02} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Connected Alerts" mediaLink={imgConMotionA05} cellSpan="col-span-1"/>
                </div>

                <bentos.CellMediaOnClick mediaLink={vidConMotionA03} mediaText="Test Text" cellSpan="col-span-1" />

                <bentos.CellMediaOnClick mediaLink={vidConMotionD02} mediaText="Test Text" cellSpan="col-span-1" />

                <bentos.CellMediaOnClick mediaLink={vidConMotionD01} mediaText="Test Text" cellSpan="col-span-1" />

                <div className={`${bentoGap} grid grid-cols-4 col-span-2 gap-[12px]`}>
                    <bentos.CellMediaOnClick mediaText="Branding Refresh" mediaLink={imgConMotionC11} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Human Intelligence" mediaLink={imgConMotionD02} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Virtual Graphics" mediaLink={imgConMotionC12} cellSpan="col-span-1"/>
                    <bentos.CellMediaOnClick mediaText="Generating Interest" mediaLink={imgConMotionC03} cellSpan="col-span-1"/>
                </div>
                ...
                <bentos.CellMediaOnClick mediaLink={vidConMotionC03} mediaText="Test Text" cellSpan="col-span-1" />
