...
function BentoBox() {
    return (
        <div className={`${bentoGap} relative z-0 grid grid-cols-2 w-[80%] h-auto justify-self-center rounded-3xl place-content-center text-white hover:cursor-pointer`}>
            ...
            <bentos.CellMediaOnClick mediaLink={vidEESA04} mediaType={MediaType.Video} mediaText="Medical animation clip" cellSpan="col-span-1"  hoverTextColor="text-textColor"/>

            <bentos.CellMediaOnClick mediaLink={vidEESB03} mediaType={MediaType.Video} mediaText="Medical animation clip" cellSpan="col-span-1" hoverTextColor="text-textColor"/>
            ...
            <div className={`${bentoGap} grid grid-cols-1 col-span-1 hover:z-20`}>
                <bentos.CellMediaOnClick mediaLink={vidMamm01} mediaType={MediaType.Video} mediaText="Medical animation clip" cellSpan="col-span-1" hoverTextColor="text-textColor"/>
            </div>
            ...
            <bentos.CellMediaOnClick mediaLink={vidEESB04} mediaType={MediaType.Video} mediaText="Medical animation clip" cellSpan="col-span-1" hoverTextColor="text-textColor"/>
            ...
            <div className={`${bentoGap} grid grid-cols-4 hover:z-20`}>
                ...
                <div className={`${bentoGap} col-span-4 hover:z-40`}>
                    <bentos.CellMediaOnClick mediaLink={vidMamm02} mediaType={MediaType.Image} mediaText="Medical animation clip" cellSpan="col-span-1" hoverTextColor="text-textColor"/>
                </div>
            </div>

            <div className={`${bentoGap} grid grid-cols-4 hover:z-20`}>
                <div className={`${bentoGap} col-span-4 hover:z-40`}>
                    <bentos.CellMediaOnClick mediaLink={vidEESC03} mediaType={MediaType.Image} mediaText="Medical animation clip" cellSpan="col-span-1" hoverTextColor="text-textVariant"/>
                </div>
