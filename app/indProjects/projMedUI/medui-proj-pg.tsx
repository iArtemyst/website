        ...
        <div className={`${bentoGap} relative z-auto grid grid-cols-1 w-[80%] h-auto justify-self-center rounded-3xl place-content-center text-textVariant hover:cursor-pointer`}>
            ...
            <div className={`${bentoGap} grid grid-cols-2 hover:z-20`}>
                ...
                <div className={`${bentoGap} grid grid-cols-2 col-span-1 hover:z-20`}>
                    ...
                    <bentos.CellMediaOnClick mediaText="Device Heat Profile" mediaLink={imgMedMotionD01} mediaType={MediaType.Image} cellSpan="col-span-1" hoverTextColor="text-textColor"/>
                </div>
            </div>
        </div>
    )
