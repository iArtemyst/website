...
function CardInternals({dataArray}:{dataArray:IProjectLinkCard}) {
    return (
        <div className={`group relative grid hover:gap-[8px] hover:lg:gap-[10px] w-fit h-auto p-[8px] lg:p-[12px] transition-all duration-300 rounded-md place-items-center`}>
    ...
    return (
        <div className={`w-full h-full place-items-center place-content-center`}>
            <CardHoverFX bufferZone={0} rotateAmount={7}>
                <div className={`${effect && "animate-error-wiggle"} bg-cardBGInactiveColor hover:bg-cardBGColor group w-fit h-fit cursor-pointer overflow-clip rounded-[8px] opacity-80 hover:opacity-100 hover:scale-[112%] active:scale-[105%] transition-all duration-200`} 
